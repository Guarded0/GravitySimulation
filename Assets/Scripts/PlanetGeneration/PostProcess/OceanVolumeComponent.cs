...
[VolumeComponentMenu("Post-processing Custom/PlanetEffects")]
[VolumeRequiresRendererFeatures(typeof(OceanRendererFeature))]
[SupportedOnRenderPipeline(typeof(UniversalRenderPipelineAsset))]
public sealed class OceanVolumeComponent : VolumeComponent, IPostProcessComponent
{
    public OceanVolumeComponent()
    {
    ...
    public ColorParameter colorA  = new ColorParameter(new Color(1.0f, 1.0f, 1.0f));
    public ColorParameter colorB = new ColorParameter(new Color(1.0f, 1.0f, 1.0f));
    public ClampedFloatParameter depthMultiplier = new ClampedFloatParameter(1f, 0f, 1f);
