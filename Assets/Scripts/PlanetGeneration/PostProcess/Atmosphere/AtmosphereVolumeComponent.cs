...
[VolumeComponentMenu("Post-processing Custom/AtmosphereEffects")]
[VolumeRequiresRendererFeatures(typeof(AtmosphereRendererFeature))]
[SupportedOnRenderPipeline(typeof(UniversalRenderPipelineAsset))]
public sealed class AtmosphereVolumeComponent : VolumeComponent, IPostProcessComponent
{
    public AtmosphereVolumeComponent()
    {
        displayName = "AtmosphereEffects";//
    }
    ...
    {
        return sunDirection.overrideState.Equals(true);
    }
}
