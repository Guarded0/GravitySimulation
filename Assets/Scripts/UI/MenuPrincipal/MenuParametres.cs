...
public class MenuParametres : MonoBehaviour
{
    ...
    public static UnityEvent parametresChanged = new UnityEvent(); // Événement pour notifier les changements de paramètres
    ...
    void Start()
    {
        ...
        GetComponent<UpdateMenu>().stateChanged.AddListener(OnStateChanged);
    }
    ...
    {
        if (newState == false) parametresChanged.Invoke();
    }
}
